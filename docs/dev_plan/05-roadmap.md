...
任务 1–8 已落地（含 dump/load wrap、Delay Stop、工作流 undo/redo）。File 菜单打开工程仍属 P5。If/Else 已落地。TextViewer 仍可延后。

...
describe('i18n', () => {
  ...
  it('translates workflow empty states', () => {
    ...
    expect(String(i18n.global.t('ribbon.chartBox'))).toBe('箱线')
    expect(String(i18n.global.t('ribbon.settings'))).toBe('设置')
    expect(String(i18n.global.t('ribbon.about'))).toBe('关于')
    expect(String(i18n.global.t('ribbon.helpMenu'))).toBe('帮助')

...
describe('resolveIconUrl', () => {
  ...
  it('resolves a ribbon action icon', () => {
    ...
    expect(resolveIconUrl('gui/cut')).toMatch(/cut\.svg/)
    expect(resolveIconUrl('gui/copy')).toMatch(/copy\.svg/)
    expect(resolveIconUrl('gui/paste')).toMatch(/paste\.svg/)
    expect(resolveIconUrl('gui/delete')).toMatch(/delete\.svg/)
    expect(resolveIconUrl('gui/select-all')).toMatch(/select-all\.svg/)
    ...
    expect(resolveIconUrl('app/transformSkewed')).toMatch(/transformSkewed\.svg/)
    ...
    expect(resolveIconUrl('app/chart-type/stats-boxplot')).toMatch(/stats-boxplot\.svg/)
    ...
    expect(resolveIconUrl('app/showChart')).toMatch(/showChart\.svg/)
    expect(resolveIconUrl('app/setting')).toMatch(/setting\.svg/)
    expect(resolveIconUrl('app/about')).toMatch(/about\.svg/)
    expect(resolveIconUrl('app/showInfomation')).toMatch(/showInfomation\.svg/)

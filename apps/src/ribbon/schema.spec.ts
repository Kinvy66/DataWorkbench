...
describe('ribbon schema', () => {
  it('keeps Data as dataset IO and puts table ops on Operate like upstream', () => {
    ...
    expect(source).toContain("id: 'edit.copy'")
    expect(source).toContain("id: 'edit.paste'")
    expect(source).toContain("id: 'edit.delete'")
    expect(source).toContain("id: 'edit.selectAll'")
    expect(source).toContain("id: 'edit.cut'")
    ...
    expect(source).not.toContain("id: 'app.pluginManager'")
    ...
    expect(commands).toContain("'app.settings'")
    ...
    expect(commands).toContain("'edit.selectAll'")
